...
class PekkoGrpcPluginExtension {
    ...
    static final String PROTOC_VERSION = "4.31.1" // checked synced by VersionSyncCheckPlugin

    static final String PROTOC_PLUGIN_SCALA_VERSION = "2.12"

    static final String GRPC_VERSION = "1.78.0" // checked synced by VersionSyncCheckPlugin
